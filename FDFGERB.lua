...
{
{text = 'Miles', url='https://t.me/kzzzp'},
},
}
}
...
Redis:set(FDFGERB.."ardode:Add:Rd:Sudo:Text4"..test, text)  
 ...
 LuaTele.sendText(msg_chat_id,msg_id,"ارسل رد الي بعدو ")
return false  
end  
end
if text then  
...
local Text3 = Redis:get(FDFGERB.."ardode:Add:Rd:Sudo:Text"..text)   
local Text3 = Redis:get(FDFGERB.."ardode:Add:Rd:Sudo:Text"..text)   
local Text5 = Redis:get(FDFGERB.."ardode:Add:Rd:Sudo:Text"..text)   
local Text6 = Redis:get(FDFGERB.."ardode:Add:Rd:Sudo:Text"..text)   
local Text7 = Redis:get(FDFGERB.."ardode:Add:Rd:Sudo:Text"..text)   
local Text8 = Redis:get(FDFGERB.."ardode:Add:Rd:Sudo:Text"..text)   
local Text9 = Redis:get(FDFGERB.."ardode:Add:Rd:Sudo:Text"..text) 
local Text10 = Redis:get(FDFGERB.."ardode:Add:Rd:Sudo:Text"..text)     
if Text or Text1 or Text2 or Text4 or Text5 or Text6 or Text7 or Text8 or Text9 or Text10 then 
local texting = {
Text,
Text1,
Text2,
...
return LuaTele.sendText(msg_chat_id,msg_id,"[𝑺𝒐𝒖𝒓𝒄𝒆 𝑴𝒊𝒍𝒆𝒔](t.me/kzzzp)\n\n[Source Manger](t.me/EE3WW)","md",true, false, false, false,reply_markup)
end
