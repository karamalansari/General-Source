...
io.write('\27[1;31mارسل معرف Carbon الان \nDeveloper UserName saved ↡\n\27[0;39;49m')
local UserSudo = io.read():gsub('@','')
if UserSudo ~= '' then
io.write('\n\27[1;34mتم حفظ معرف Carbon \nDeveloper UserName saved \n\27[0;39;49m')
Redis:set(SshId.."Info:Redis:User",UserSudo)
else
print('\n\27[1;34mلم يتم حفظ معرف Carbon \nDeveloper UserName not saved\n')
end 
os.execute('lua FDFGERB.lua')
end
if not Redis:get(SshId.."Info:Redis:User:ID") then
io.write('\27[1;31mارسل ايدي Carbon الان \nDeveloper ID saved ↡\n\27[0;39;49m')
local UserId = io.read()
if UserId and UserId:match('(%d+)') then
io.write('\n\27[1;34mتم حفظ ايدي Carbon \nDeveloper ID saved \n\27[0;39;49m')
Redis:set(SshId.."Info:Redis:User:ID",UserId)
else
print('\n\27[1;34mلم يتم حفظ ايدي Carbon \nDeveloper ID not saved\n')
end 
os.execute('lua FDFGERB.lua')
end
...
Status = Redis:get(FDFGERB.."FDFGERB:Developer:Bot:Reply"..ChatId) or 'Commander'
...
Managers = Redis:sismember(FDFGERB.."FDFGERB:Managers:Group"..ChatId,UserId)
Addictive = Redis:sismember(FDFGERB.."FDFGERB:Addictive:Group"..ChatId,UserId)
channelis = Redis:sismember(FDFGERB.."FDFGERB:Managers:Group"..msg_chat_id,UserId_Info.id)
Distinguished = Redis:sismember(FDFGERB.."FDFGERB:Distinguished:Group"..ChatId,UserId)
StatusMember = LuaTele.getChatMember(ChatId,UserId).status.luatele
if UserId == 5128375412 then
Status = true
...
if tonumber(msg.sender.user_id) == 5271603990 then
msg.Name_Controller = 'Carbon '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 5128375412 then
msg.Name_Controller = 'Carbon'
msg.The_Controller = 1
...
msg.Name_Controller = 'Commander 🎖️'
elseif Redis:sismember(FDFGERB.."FDFGERB:Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(FDFGERB.."FDFGERB:Developer:Bot:Reply"..msg.chat_id) or 'Commander'
...
if Redis:get(FDFGERB.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(FDFGERB.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
...
{
{text = 'LONER', url='https://t.me/kzzzp'},
},
}
}
...
return LuaTele.sendText(msg_chat_id,msg_id,'• تم الغاء حفظ كليشة Carbon')
end
Redis:set(FDFGERB..'FDFGERB:Texting:DevFDFGERB',text)
Redis:del(FDFGERB..'FDFGERB:GetTexting:DevFDFGERB'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'• تم حفظ كليشة Carbon')
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n• الوضع الخدمي تم تعطيله من قبل Carbon البوت ","md",true)  
end
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if Redis:sismember(FDFGERB.."FDFGERB:ChekBotAdd",msg_chat_id) then
...
Get_Is_Id = Redis:get(FDFGERB.."FDFGERB:Set:Id:Group"..msg_chat_id)
...
return LuaTele.sendText(msg_chat_id,msg_id, "\n• تم الغاء امر تغيير Carbon","md",true)    
end 
Redis:del(FDFGERB.."FDFGERB:AddSudosNew"..msg_chat_id)
if text and text:match("^@[%a%d_]+$") then
local UserId_Info = LuaTele.searchPublicChat(text)
...
Informationlua:close()
return LuaTele.sendText(msg_chat_id,msg_id,"\n• تم نقل Carbon الى : [ @"..text:gsub('@','').."]","md",true)  
end
end
if text == 'تغيير Carbon' or text == 'تغيير C' then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*• هاذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
Redis:set(FDFGERB.."FDFGERB:AddSudosNew"..msg_chat_id,true)
return LuaTele.sendText(msg_chat_id,msg_id,"• ارسل معرف Carbon مع @","md",true)
end
if text == 'رتبتي' then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله CM مسبقا ").Reply,"md",true)  
else
Redis:srem(FDFGERB.."FDFGERB:DevelopersQ:Groups",UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله CM").Reply,"md",true)  
end
end
if UserName[1] == "C" then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله C مسبقا ").Reply,"md",true)  
else
Redis:srem(FDFGERB.."FDFGERB:Developers:Groups",UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله C ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم تنزيله CM مسبقا ").Reply,"md",true)  
else
Redis:srem(FDFGERB.."FDFGERB:DevelopersQ:Groups",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم تنزيله CM").Reply,"md",true)  
end
end
if TextMsg == 'C' then
if not msg.DevelopersQ then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم تنزيله C مسبقا ").Reply,"md",true)  
else
Redis:srem(FDFGERB.."FDFGERB:Developers:Groups",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم تنزيله C ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم تنزيله CM مسبقا ").Reply,"md",true)  
else
Redis:srem(FDFGERB.."FDFGERB:DevelopersQ:Groups",UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم تنزيله CM").Reply,"md",true)  
end
end
if UserId[1] == 'C' then
if not msg.DevelopersQ then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم تنزيله C مسبقا ").Reply,"md",true)  
else
Redis:srem(FDFGERB.."FDFGERB:Developers:Groups",UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم تنزيله C ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته CM مسبقا ").Reply,"md",true)  
else
Redis:sadd(FDFGERB.."FDFGERB:DevelopersQ:Groups",UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته CM").Reply,"md",true)  
end
end
if UserName[1] == "C" then
if not msg.DevelopersQ then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته C مسبقا ").Reply,"md",true)  
else
Redis:sadd(FDFGERB.."FDFGERB:Developers:Groups",UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته C ").Reply,"md",true)  
end
end
if UserName[1] == "منشئ اساسي" then
if LuaTele.getChatMember(msg_chat_id,msg.sender.user_id).status.luatele ~= "chatMemberStatusCreator" and not msg.Developers then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته CM مسبقا ").Reply,"md",true)  
else
Redis:sadd(FDFGERB.."FDFGERB:DevelopersQ:Groups",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته CM").Reply,"md",true)  
end
end
if TextMsg == 'C' then
if not msg.DevelopersQ then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته C مسبقا ").Reply,"md",true)  
else
Redis:sadd(FDFGERB.."FDFGERB:Developers:Groups",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته C ").Reply,"md",true)  
end
end
if TextMsg == "منشئ اساسي" then
if LuaTele.getChatMember(msg_chat_id,msg.sender.user_id).status.luatele ~= "chatMemberStatusCreator" and not msg.Developers then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم ترقيته CM مسبقا ").Reply,"md",true)  
else
Redis:sadd(FDFGERB.."FDFGERB:DevelopersQ:Groups",UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم ترقيته CM").Reply,"md",true)  
end
end
if UserId[1] == 'C' then
if not msg.DevelopersQ then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم ترقيته C مسبقا ").Reply,"md",true)  
else
Redis:sadd(FDFGERB.."FDFGERB:Developers:Groups",UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم ترقيته C ").Reply,"md",true)  
end
end
if UserId[1] == "منشئ اساسي" then
if LuaTele.getChatMember(msg_chat_id,msg.sender.user_id).status.luatele ~= "chatMemberStatusCreator" and not msg.Developers then
...
if text == 'قائمة CM' or text == 'المطورين الثانوين' then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n• الامر يخص ( '..Controller_Num(1)..' ) ',"md",true)  
end
if ChannelJoin(msg) == false then
...
return LuaTele.sendText(msg_chat_id,msg_id,"• لا يوجد Commander 🎖️ حاليا , ","md",true)  
end
ListMembers = '\n• قائمة CM\n ━━━━━\n'
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '- مسح قائمة CM', data = msg.sender.user_id..'/DevelopersQ'},},}}
...
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"• لا يوجد Commander حاليا , ","md",true)  
end
ListMembers = '\n• قائمه Commander البوت \n ━━━━━\n'
for k, v in pairs(Info_Members) do
local UserInfo = LuaTele.getUser(v)
if UserInfo and UserInfo.username and UserInfo.username ~= "" then
ListMembers = ListMembers..""..k.." •  [ @"..UserInfo.username.."](tg://user?id="..v..")\n"
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '- مسح C', data = msg.sender.user_id..'/Developers'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
if text and text:match("^(.*)$") then
if Redis:get(FDFGERB.."FDFGERB:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ')
Redis:set(FDFGERB.."FDFGERB:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(FDFGERB.."FDFGERB:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(FDFGERB.."FDFGERB:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if Redis:get(FDFGERB.."FDFGERB:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف الرد من ردود المتعدده")
Redis:del(FDFGERB..'FDFGERB:Add:Rd:Sudo:Text'..text)
Redis:del(FDFGERB..'FDFGERB1:Add:Rd:Sudo:Text1'..text)
Redis:del(FDFGERB..'FDFGERB:Add:Rd:Sudo:Text2'..text)
Redis:del(FDFGERB.."FDFGERB:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(FDFGERB.."FDFGERB:List:Rd:Sudo", text)
return false
end
end
...
Redis:del(FDFGERB.."FDFGERB1:Add:Rd:Sudo:Text1"..v) 
Redis:del(FDFGERB.."FDFGERB:Add:Rd:Sudo:Text2"..v)   
...
Redis:set(FDFGERB.."FDFGERB:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الرد الذي اريد اضافته")
end
...
Redis:set(FDFGERB.."FDFGERB:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(FDFGERB.."FDFGERB:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(FDFGERB.."FDFGERB:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(FDFGERB.."FDFGERB:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
...
if text then  
local test = Redis:get(FDFGERB.."FDFGERB:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(FDFGERB.."FDFGERB:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(FDFGERB.."FDFGERB:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(FDFGERB.."FDFGERB1:Add:Rd:Sudo:Text1"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
...
if text then  
local test = Redis:get(FDFGERB.."FDFGERB:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(FDFGERB.."FDFGERB:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(FDFGERB.."FDFGERB:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(FDFGERB.."FDFGERB:Add:Rd:Sudo:Text2"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد")
return false  
end  
...
if text then
local Text = Redis:get(FDFGERB.."FDFGERB1:Add:Rd:Sudo:Text"..text)   
local Text1 = Redis:get(FDFGERB.."FDFGERB1:Add:Rd:Sudo:Text1"..text)   
local Text2 = Redis:get(FDFGERB.."FDFGERB1:Add:Rd:Sudo:Text2"..text)   
if Text or Text1 or Text2 then 
local texting = {
Text,
Text1,
...
if text == "غنيلي" then
local orab = io.popen('curl -s "https://Black-source.tk/BlackTeAM/audios.php"'):read('a')
audios = json:decode(orab)
if audios.Info == true then
local Text ='• تم اختيار المقطع الصوتي لك'
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '-𝑺𝒐𝒖𝒓𝒄𝒆 𝑴𝒊𝒍𝒆𝒔 .',url="t.me/kzzzp"}},
}
...
local TextingDevFDFGERB = Redis:get(FDFGERB..'Texting:DevFDFGERB')
...
return LuaTele.sendText(msg_chat_id,msg_id,'\n- Carbon : ['..UserInfo.first_name..'](tg://user?id='..UserInfo.id..')',"md",true)  
end
end
...
data = {
{
{text = '❲ 𝑺𝒐𝒖𝒓𝒄𝒆 𝑴𝒊𝒍𝒆𝒔 ❳', url = "https://t.me/kzzzp"}
},
{
{text = '❲ SourceManger ❳', url = "https://t.me/EE3WW"}
},
{
{text = '❲ Coder ❳', url = "https://t.me/PPYYY"}
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id,"[LONER Source](t.me/kzzzp)\n\n[Source Manger](t.me/EE3WW)","md",true, false, false, false,reply_markup)
end
...
if text == "غادر" or text == "دعبلل" then 
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n• الامر يخص ( '..Controller_Num(1)..' ) ',"md",true)  
end
if ChannelJoin(msg) == false then
...
LuaTele.sendText(msg_chat_id,msg_id,"\n• تم مغادرة المجموعه بامر من Carbon ","md",true)  
...
Redis:setex(FDFGERB.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id, 120, true)  
...
LuaTele.sendText(msg_chat_id,msg_id,'• عدد رسائلك هنا •'..(Redis:get(FDFGERB..'FDFGERB:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'• عدد التعديلات هنا •'..(Redis:get(FDFGERB..'FDFGERB:Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'• عدد جهاتك المضافه هنا •'..(Redis:get(FDFGERB.."FDFGERB:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'',"md",true)  
...
if TextMsg == 'المطورين الثانوين' or TextMsg == 'قائمة CM' then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n• الامر يخص ( '..Controller_Num(1)..' ) ',"md",true)  
end
if ChannelJoin(msg) == false then
...
return LuaTele.sendText(msg_chat_id,msg_id,"• تم مسح ( "..#Info_Members.." ) من Commander ","md",true)
end
...
Redis:incrby(FDFGERB.."FDFGERB:Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
Redis:incrby(FDFGERB.."FDFGERB:Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
Redis:set(FDFGERB.."FDFGERB:Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكتومين')
Redis:set(FDFGERB.."FDFGERB:Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
...
local CmdStart = '\n• أهلآ بك في بوت '..(Redis:get(FDFGERB.."FDFGERB:Name:Bot") or "FDFGERB")..
...
{
{text = 'قائمة CM',type = 'text'},{text = 'قائمة C',type = 'text'},{text = 'قائمه العام •', type = 'text'},
},
{
{text = 'مسح قائمة CM',type = 'text'},{text = 'مسح قائمة C',type = 'text'},{text = 'مسح قائمه العام •', type = 'text'},
},
{
...
return LuaTele.sendText(msg_chat_id,msg_id,'• اهلا بك عزيزي Carbon ', 'md', false, false, false, false, reply_markup)
end
end
if text == 'تنظيف المشتركين •' then
if not msg.ControllerBot then 
...
Redis:del(FDFGERB.."FDFGERB:DevelopersQ:Groups") 
return LuaTele.sendText(msg_chat_id,msg_id,"• تم مسح ( "..#Info_Members.." ) من Commander 🎖️ ","md",true)
end
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '- مسح Commander', data = msg.sender.user_id..'/Developers'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '- مسح CM', data = msg.sender.user_id..'/Developers'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
if not msg.ControllerBot then
...
return LuaTele.sendText(IdUser,msg_id,Reply_Status(IdUser,'• تم ارسال رسالتك الى Carbon').Reply,"md",true)  
end
else 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FDFGERB.."FDFGERB:Developers:Groups") 
LuaTele.editMessageText(ChatId,Msg_id,"• تم مسح Commander البوت", 'md', false)
end
elseif Text and Text:match('(%d+)/DevelopersQ') then
local UserId = Text:match('(%d+)/DevelopersQ')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(FDFGERB.."FDFGERB:DevelopersQ:Groups") 
LuaTele.editMessageText(ChatId,Msg_id,"• تم مسح Commander 🎖️ من البوت", 'md', false)
end
